!(function (e, t) {
  ...
  var J,
    ...
    ze = function (e, t) {
      ...
      if ((n = c ? r : u ? r[l] || j(l, {}) : (r[l] || {}).prototype))
        for (i in t) {
          if (
            ((a = t[i]),
            (o = e.noTargetGet ? (s = je(n, i)) && s.value : n[i]),
            !Re(c ? i : l + (u ? "." : "#") + i, e.forced) && void 0 !== o)
          ) {
    ...
    qe = function (e) {
      return (
        m(Me, e) ||
          (Ce && m(Ne, e) ? (Me[e] = Ne[e]) : (Me[e] = De("Symbol." + e))),
        Me[e]
      );
    },
    Ue = qe("species"),
      ...
      concat: function (e) {
        ...
        for (t = -1, r = arguments.length; t < r; t++)
          if (((o = -1 === t ? a : arguments[t]), Qe(o))) {
            if (l + (i = ce(o.length)) > 9007199254740991)
    ...
    ct = function (e, t) {
      ...
      return (st[e] =
        ...
        !i(function () {
          if (r && !o) return !0;
          var e = { length: -1 };
          r ? at(e, 1, { enumerable: !0, get: lt }) : (e[1] = 1),
            n.call(e, a, s);
        }));
    },
    ut = it.forEach,
  ...
  var Lt = { IteratorPrototype: Et, BUGGY_SAFARI_ITERATORS: Ct },
    ...
    Bt = function (e, t, n, r, i, o, a) {
      !(function (e, t, n) {
        var r = t + " Iterator";
        (e.prototype = wt(qt, { next: c(1, n) })), Dt(e, r, !1), (Rt[r] = Ut);
      })(n, t, r);
      var s,
        l,
        u,
      ...
      if (
        (y &&
          ...
          Ft !== Object.prototype &&
            s.next &&
            (Pt(s) !== Ft &&
              (Zt ? Zt(s, Ft) : "function" != typeof s[Ht] && R(s, Ht, Wt)),
            Dt(s, h, !0))),
        "values" == i &&
          d &&
          "values" !== d.name &&
        ...
        else ze({ target: t, proto: !0, forced: Gt || p }, l);
      return l;
    },
    Vt = ee.set,
    ...
    { target: "Array", proto: !0, forced: !en || !tn },
    {
      slice: function (e, t) {
        ...
        if (
          ...
          return rn.call(o, s, l);
        for (
          r = new (void 0 === n ? Array : n)(on(l - s, 0)), i = 0;
          s < l;
          s++, i++
        )
          s in o && Ie(r, i, o[s]);
  ...
  var cr,
      ...
      if (!t.notified) {
        ...
        pr(function () {
          for (var i = t.value, o = 1 == t.state, a = 0; r.length > a; ) {
            ...
            try {
              f
                ? (o || (2 === t.rejection && qr(e, t), (t.rejection = 1)),
                  !0 === f
                    ? (s = i)
                    : (g && g.enter(), (s = f(i)), g && (g.exit(), (c = !0))),
                  s === u.promise
    ...
    qr = function (e, t) {
      br.call(r, function () {
        zr
          ? Tr.emit("rejectionHandled", e)
          : Mr("rejectionhandled", e, t.value);
      });
    },
    Ur = function (e, t, n, r) {
      return function (i) {
      ...
      var oi = function (e, t) {
          ...
          var a,
            ...
            f =
              ...
              (l = oi),
              Zt &&
                "function" == typeof (c = s.constructor) &&
                c !== l &&
                v((u = c.prototype)) &&
                u !== l.prototype &&
                Zt(a, u),
    ...
    return [
      ...
      function (e) {
        ...
        for (var s, l = [], c = 0; null !== (s = Ii(i, o)); ) {
          var u = String(s[0]);
          (l[c] = u),
            "" === u && (i.lastIndex = Pi(o, ce(i.lastIndex), a)),
            c++;
        }
        return 0 === c ? null : l;
      },
        ...
        [
          ...
          function (e, i) {
            ...
            for (var p = 0, g = 0, d = []; g < s.length; ) {
              f.lastIndex = Zi ? g : 0;
              var v,
                y = Ii(f, Zi ? s : s.slice(g));
              if (
                null === y ||
                (v = Ui(ce(f.lastIndex + (Zi ? 0 : g)), s.length)) === p
              )
                g = Pi(s, g, c);
              else {
  ...
  ze(
    { target: "String", proto: !0, forced: !qo && !Do },
    {
  ...
  var Uo = Vi.end,
    ...
    Fo = Zo
      ...
      : "".trimEnd;
  ze(
    { target: "String", proto: !0, forced: Zo },
    { trimEnd: Fo, trimRight: Fo }
  );
  var Go = t(function (e) {
      function t() {
        return {
      ...
      splice: function (e, t) {
        ...
        if (
          (0 === f
            ...
            : 1 === f
            ? ((n = 0), (r = c - u))
            : ((n = f - 2), (r = Vo(Bo(se(t), 0), c - u))),
          c + n - r > 9007199254740991)
        )
          throw TypeError("Maximum allowed length exceeded");
        for (i = Ze(l, r), o = 0; o < r; o++)
          (a = u + o) in l && Ie(i, o, l[a]);
        if (((i.length = r), n < r)) {
          for (o = u; o < c - r; o++)
              ...
              if (i)
                return (
                  (r =
                    "@" === i[2]
                      ? "mailto:" +
                        (n = Ea(this.options.mangle ? t(i[1]) : i[1]))
                      : (n = Ea(i[1]))),
                  {
                    type: "link",
                    raw: i[0],
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if ((n = this.rules.inline.url.exec(e))) {
                ...
                if ("@" === n[2])
                  i =
                    "mailto:" + (r = Ea(this.options.mangle ? t(n[0]) : n[0]));
                else {
                  var o;
                  do {
                    (o = n[0]),
                ...
                for (
                  ...
                  if ((t = this.tokenizer.escape(e)))
                    ...
                    (e = e.substring(t.raw.length)),
                      (t.tokens = this.inlineTokens(t.text, [], r, i)),
                      n.push(t);
                  else if ((t = this.tokenizer.autolink(e, Da)))
                    (e = e.substring(t.raw.length)), n.push(t);
        ...
        uo(e, [
          ...
          },
          {
            ...
            value: function (e, t, n) {
              if (
                null ===
                (e = Za(this.options.sanitize, this.options.baseUrl, e))
              )
                return n;
              var r = '<a href="' + Fa(e) + '"';
                  ...
                  switch ((u = e[t]).type) {
                    ...
                    case "table":
                      ...
                      for (
                        ...
                        for (
                          s = "", o = (a = u.tokens.cells[n]).length, r = 0;
                          r < o;
                          r++
                        )
  ...
  return function () {
    ...
    function i(e, t) {
      ...
      return (
        2 === n.length &&
          (e = n[0] + '<aside class="notes">' + rs(n[1].trim()) + "</aside>"),
    ...
    function s(e, t, n) {
      ...
      if ((r = o.exec(s))) {
        var l = r[1];
        for (
          s = s.substring(0, r.index) + s.substring(o.lastIndex),
            e.nodeValue = s;
          (i = a.exec(l));
