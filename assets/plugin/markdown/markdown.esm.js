...
var P,
  ...
  Z = function (e) {
    return (
      "Symbol(" + String(void 0 === e ? "" : e) + ")_" + (++q + U).toString(36)
    );
  },
  F = D("keys"),
  G = function (e) {
  ...
  ct = function (e, t) {
    ...
    return (st[e] =
      ...
      !i(function () {
        if (r && !o) return !0;
        var e = { length: -1 };
        r ? at(e, 1, { enumerable: !0, get: lt }) : (e[1] = 1), n.call(e, a, s);
      }));
  },
  ut = it.forEach,
  ft = ot("forEach"),
      ...
      if (o) a = e;
        ...
        if (void 0 !== (p = s) && (Rt.Array === p || kn[mn] === p)) {
          for (l = 0, c = ce(e.length); c > l; l++)
            if ((u = i ? g(A((h = e[l]))[0], h[1]) : g(e[l])) && u instanceof t)
              return u;
          return new t(!1);
        }
        a = s.call(e);
          ...
          ? function (e, n) {
              ...
              for (
                ...
                !(
                  ...
                  o.length > 1 && o.index < r.length && qi.apply(l, o.slice(1)),
                  (s = o[0].length),
                  (u = a),
                  l.length >= i)
                );
              ...
              for (t = 0; t < x; t++)
                switch ((u = e[t]).type) {
                  ...
                  case "code":
                    ...
                    continue;
                  case "table":
                    for (l = "", s = "", i = u.header.length, n = 0; n < i; n++)
...
export default function () {
  ...
  function s(e, t, n) {
    ...
    if ((r = o.exec(s))) {
      var l = r[1];
      for (
        s = s.substring(0, r.index) + s.substring(o.lastIndex), e.nodeValue = s;
        (i = a.exec(l));
